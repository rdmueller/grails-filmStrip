...
A not so well known feature is the http://www.gebish.org/manual/current/testing.html#reporting[++report++] feature: whenever you unse the command ++report "some text"++, 
